...
const About = () => {
  ...
  return (
    <div>
      ...
      <p>
        Donec scelerisque ipsum nulla, at tincidunt mauris placerat a. Nullam et
        nibh et leo facilisis pharetra vitae eu urna. Duis facilisis ligula
        lobortis quam sodales eleifend. Mauris semper dolor ut fringilla
        consectetur. Maecenas pretium eros leo, non lobortis turpis ultrices ac.
        Ut a auctor purus, nec volutpat augue. Etiam maximus sem sed arcu
        volutpat ultricies. Proin vestibulum nibh nec tellus aliquet tempor.
        Morbi imperdiet pulvinar augue sed pulvinar. Pellentesque habitant morbi
        tristique senectus et netus et malesuada fames ac turpis egestas. Nam
        porttitor ornare aliquam. Quisque in nisi quis orci finibus fringilla at
        non felis. Curabitur in fermentum libero. Curabitur venenatis sed tortor
        hendrerit fringilla. Maecenas commodo convallis nulla, non condimentum
        odio.
      </p>
    </div>
  );
